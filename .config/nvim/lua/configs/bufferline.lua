vim.keymap.set('n', '<C-j>', '<Cmd>BufferLineGoToBuffer 1<CR>')
vim.keymap.set('n', '<C-k>', '<Cmd>BufferLineGoToBuffer 2<CR>')
vim.keymap.set('n', '<C-l>', '<Cmd>BufferLineGoToBuffer 3<CR>')
vim.keymap.set('n', '<C-p>', '<Cmd>BufferLineGoToBuffer 4<CR>')
